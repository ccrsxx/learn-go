...
## Section 1: Getting Started on <https://go.dev/doc/tutorial>

Core concepts learned from the official Go tutorial, covering module initialization, imports, variables, and basic project structure.
...
## Section 2: A Tour of Go on <https://go.dev/tour>
